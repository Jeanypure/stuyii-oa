...
<div class="oa-goods-form">
    ...
    <?= $form->field($model,'cate')->dropDownList($model->getCityList(0),
        [
            'prompt'=>'--请选择父类--',
            'onchange'=>'
           
            $.get("'.yii::$app->urlManager->createUrl('oa-goods/create').'?typeid=1&pid="+$(this).val(),function(data){
                var str="";
    ...
    <?= $form->field($model,'subCate')->dropDownList($model->getCityList($model->cate),
        [
            'prompt'=>'--请选择子类--',
